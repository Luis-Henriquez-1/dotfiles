...
#+begin_src emacs-lisp
(defun use-package:insert-keyword (where place key plist)
...
#+begin_src emacs-lisp
(defun use-package:dwim-insert (key &optional before place)
  "Same as KEY but defaults to PLACE."
  (setq use-package-keywords
	(use-package:insert-keyword 'before :hook key)))
#+end_src
...
****** automate simple use-package keywords
:PROPERTIES:
:ID:       b4902665-1c9b-4958-ab00-b70c365dac13
:END:

The keywords I'm using for [[8fb485ec-5387-46da-820e-629dcf004962][generic advices]] all follow the same pattern in
terms of their handler and normalizer. I can automate this.

******* general advice normalizer
:PROPERTIES:
:ID:       e53266ea-7158-4fd8-b4ec-f54ad1c82361
:END:

******* general advice handler
:PROPERTIES:
:ID:       903f0b00-8487-49bf-aa94-6b7f1fbe80f8
:END:

#+begin_src emacs-lisp
(defun use-package-general-advice-handler (fn)
  "Return a general advice handler for FN."
  `(lambda ()))
#+end_src
...
(defalias 'use-package-normalize/:xl-silence ())

(defalias 'use-package-handler/:xl-silence ())
...
(defun use-package-normalize/:xl-ignore ()
  (cl-assert (-all-p #'symbolp args))
  args)
...
(defun use-package-handler/:xl-set (name key value rest state)
...
#+begin_src emacs-lisp
(use-package:insert-keyword :xl-config)
...
#+begin_src emacs-lisp
(use-package:insert-keyword :xl-alias)
...
#+begin_src emacs-lisp
(use-package:insert-keyword :xl-ensure)
...
#+begin_src emacs-lisp
(use-package:insert-keyword :xl-namless)
...
(defun xl-always-yes (fn &optional props expire-fn)
  "Ignore yes or no prompt."
  (let ((name (xl-advice-name name fn))
	(body (noflet ((y-or-n-p (prompt) t)) (apply orig-fn args))))
    (fset name `(lambda (orig-fn &rest args) ,body))
    (xl-add-advice fn :around name props expire-fn)))
#+end_src
