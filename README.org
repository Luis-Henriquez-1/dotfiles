...
full screen, especially when I'm using emacs as my window manager.
...
(xl-dir! XL-ORG-DIR (expand-file-name "~/Documents/org/")
...
(use-package helm-themes
  :init
  (general-def [remap load-theme] #'helm-themes))
#+end_src
...
=tempo-snippets= doesn't handle user elements. The writers of =tempo-snippets=
actually have [[][a FIXME line]] where they say they haven't done this yet. So
if you're like me and defined any, they will be ignored. The purpose of this
headline is to address this problem.

Unfortunately, the function where I need to fix this doesn't have a clean way
for me to do it cleanly. I need to change its [[][let binding]].
...
(define-leader-key!
  :infix "as"
  "s" (list :def #'xl/take-screenshot-fullscreen :wk "screenshot")
  "w" (list :def #'escr-window-screenshot :wk "window")
  "f" (list :def #'xl/take-screenshot-fullscreen  :wk "fullscreen"))
#+end_src
