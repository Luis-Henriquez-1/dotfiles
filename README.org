...
in a helm window. Specifically it uses [[https://github.com/abo-abo/avy][avy]] to letter the candidates. You
can then enter call [[helpfn:ace-jump-helm-line][ace-jump-helm-line]] by pressing a key (I bound it to =C-'=),
