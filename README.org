...
consistent documentation throughout. Moreover, more often than not configuration
...
The setup for mbsync contains many repetative blocks of it's DSL which are
