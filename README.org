...
(defun xl-remove-advice (xl-advice-fn)
  ...
  (advice-remove (xl-advice-orig-var xl-advice-fn) xl-advice-fn))
#+end_src
...
******* macro for defining capture templates
:PROPERTIES:
:ID:       4ee166c6-34ed-42b0-9187-4968bf92be03
:END:

#+begin_src emacs-lisp
(defmacro org-capture-template! (name &rest args)
  "Convenience macro for declaratively defining a capture template."
  `(after! org-capture
...
#+begin_src emacs-lisp
(defun org-capture:generic-template-node ()
  "Return a generic capture template."
...
******** capture
:PROPERTIES:
:ID:       ae988ccd-f335-4158-8a32-e82873fbb5b4
:END:

******** org
:PROPERTIES:
:ID:       e484f0bb-b4b1-45a3-831d-8283e3a8a123
:END:
...
#+begin_src emacs-lisp
(defun exwm:website-link ()
  "Return the link of the website."
  (funcall exwm:website-link-fn))
#+end_src
...
(defun xl-take-webshot (url)
  ...
  (let ((default-directory (xl-webshot-dir)))
