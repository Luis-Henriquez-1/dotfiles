...
this. It's certainly unorthodox. However, I was convinced by the benefits. For
one thing it is simpler to have everything (except a small amount of bootstrap
code) in one file as opposed to having a complex heirarchy of files and
directories. Having my configuration files in an org-mode files means I can have
consistent documentation that's all in the same syntax--and even better, with
markup capabilities. Documentation comments, in my opinion, are antiquated; they
are not expressive enough. Sometimes, I want to show a picture or a gif of what
I'm talking about. Moreover, more often than not configuration files are
