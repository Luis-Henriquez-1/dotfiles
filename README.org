...
effectively stop garbage collection by setting the.
...
(xl-dir! XL-DOCUMENTS-DIR (expand-file-name "~/Documents/")
  "Directory where documents are stored.")

(xl-dir! XL-TRASH-DIR (expand-file-name "~/Downloads/")
  "Directory where downloads are stored.")

(xl-dir! xl-trash-dir (expand-file-name "~/Trash/")
  "Directory where downloads are stored.")
#+end_src
