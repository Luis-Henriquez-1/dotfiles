...
(defun use-package-normalize/:xl-rule ()
  (cl-assert (-all-p #'xl-true-list-p args))
  args)

(defun use-package-handler/:xl-rule ()
...
(defun use-package-normalize/:xl-idle-require ()
  (cl-assert (-all-p #'symbolp args))
  (--map-when (eq t it) name args))

(defun use-package-handler/:xl-idle-require ()
