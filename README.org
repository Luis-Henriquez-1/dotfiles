...
this. It's certainly unorthodox. However, I was convinced by the
benefits. Moreover, more often than not configuration files are interrelated. By
linking to eachother.
...
When you initialize documentation on different machine settings can be
different. When using a mac you might want one thing and when using a.
...
** highlights
:PROPERTIES:
:ID:       25684c50-da42-429e-8eb4-2d45a0bbdfb5
:END:
