...
Here I install the package manager.
...
[[][use-package]] provides a uniform syntax for cross-configuring different
packages and features. It is widely used among the emacs community.
...
address this I create this function which.
