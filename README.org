...
#+begin_src emacs-lisp
(defun use-package:dwim-insert (key)
  "Insert KEY."
...
(defun use-package-normalize/:xl-hook (name key args)
...
(defun use-package-handler/:xl-hook (name key value rest state)
...
(defun use-package-normalize/:xl-set (name key args)
