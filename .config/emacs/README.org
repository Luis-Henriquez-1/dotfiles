...
(setq initial-buffer-choice
      (if void-debug-p (lambda () (get-buffer "*Messages*")) t))
...
(setq-default byte-compile-verbose void-debug-p)
...
compete and win against other "modern" text editors.
