...
I had seen hydras before, but I got the idea of using them instead of just which
key after looking at [[https://github.com/seagle0128/.emacs.d/blob/master/lisp/init-hydra.el][Centaur Emacs]]. I'm sure many of us can relate to the
feeling of traversing through themes like TV channels, spending 5 or more
minutes trying to find the one that satisfies our urges for now.
