...
(use-package! yasnippet-snippets
  :after yasnippet
  :init
  (awhen! (seq-first (fn! (s-contains-p "yasnippet-snippets" <path>)) load-path)
...
ELEMENTS is a list of headline elements (see `org:element-headline-elements')."
  (awhen! (seq-first (fn! (seq-some-p (apply-partially #'org:element-contains-point-p point)
                                      <it>))
...
(defun org:dwim-description-bounds (point elements)
  ...
  (acond
   ...
   ((seq-first (fn! (eq 'property-drawer (org-element-type <element>)))
               (reverse elements))
