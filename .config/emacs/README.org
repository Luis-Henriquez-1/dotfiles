...
**** variables
:PROPERTIES:
:ID:       e3553cde-4e5d-4540-9e8e-64674fb18581
:END:

#+begin_src emacs-lisp
(setq package-user-dir (concat VOID:PACKAGES-DIR))
#+end_src

**** install fn
:PROPERTIES:
:ID:       55726235-2963-42ab-9a83-e897fe9083d7
:END:
...
#+begin_src emacs-lisp
(dolist (package '(leaf leaf-keywords dash anaphora quelpa))
  (funcall #'package:install-package package)
  (require package))
(leaf-keywords-init)
#+end_src
