...
(pretty-hydra-define hydra:theme (:title (pretty-hydra-title "Themes" 'faicon "paint-brush")
  ...
  ("Traverse"
   ...
   "Favorites"
   (("i" theme-looper:ignore-current "ignore")
    ("f" theme-looper:add-current-to-favorite "font"))
   "Circadian"
   (("d" theme-looper:enable-dark-theme "dark")
    ("l" theme-looper:enable-light-theme "light"))))
#+end_src
