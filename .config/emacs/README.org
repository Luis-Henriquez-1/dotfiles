...
doing so that could be automated.

#+begin_src emacs-lisp
(cl-defun +leaf-define-keyword (keyword place &key normalizer defer alias form)
...
is the form that will be added to."
  ...
  (when defer
    (push keyword leaf-defer-keywords))

  ;; Set up aliases.
  (let ((aliases alias))
    (dolist (alias aliases)
      (push (cons alias keyword) leaf-alias-keyword-alist)))

  ;; Add a normalizer.
  (when normalizer
    (push `((or (eq leaf--key ,keyword)
                (eq ,keyword (alist-get leaf--key leaf-alias-keyword-alist)))
            (funcall #',normalizer))
          leaf-normalize))
...
#+begin_src emacs-lisp
(+leaf-define-keyword :+setq '(before :setq)
...
#+begin_src emacs-lisp
(+leaf-define-keyword :+pre-setq '(before :pre-setq)
                      :normalizer #'+leaf-normalizer-+setq
                      :alias (list :pre-setq)
...
#+begin_src emacs-lisp
(+leaf-define-keyword :+custom '(before :custom)
                      :normalizer #'+leaf-normalizer-+setq
                      :alias (list :custom)
...
#+begin_src emacs-lisp
(+leaf-define-keyword :+setq-default '(before :setq-default)
                      :normalizer #'+leaf-normalizer-+setq
...
(+leaf-define-keyword :before-call '(before :hook)
                      ...
                      :form '`((leaf-handler-advice-call! ,leaf--name :before ,leaf--value) ,@leaf--body))
#+end_src
...
(+leaf-define-keyword :after-call '(before :hook)
                      :defer t
                      :normalizer #'+leaf-normalizer-commands
                      :form '`((leaf-handler-advice-call! ,leaf--name :after ,leaf--value) ,@leaf--body))
#+end_src
...
#+begin_src emacs-lisp
(+leaf-define-keyword :+straight '(before :straight)
                      :alias (list :ensure)
                      :form
