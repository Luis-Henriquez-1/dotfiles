...
#+begin_src emacs-lisp
(push :load-incrementally leaf-defer-keywords)

(let ((it '(:load-incrementally `((append! void-incremental-packages ',leaf--value) ,@leaf--body))))
  (setq leaf-keywords (leaf-insert-list-before leaf-keywords :before-call it)))
#+end_src
...
(leaf message
  :ensure nil
  :setq
  (message-signature . "Luis Henriquez")
