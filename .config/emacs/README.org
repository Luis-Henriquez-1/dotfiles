...
Many of these utilities come from the [[][selectrum wiki]].

**** TODO select x-font function for ivy and selectrum
:PROPERTIES:
...
(defun selectrum/org-select-tags ()
  ...
  (let ((all-tags (org-get-tags)))
    (org-set-tags (completing-read-multiple "Select org tag(s): " all-tags))))
#+end_src
