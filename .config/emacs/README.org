...
** prescient
:PROPERTIES:
:ID:       5ff6e6e0-af0d-4e21-8ba0-c2cb6438e757
:END:
...
*** all-the-icons-ivy
:PROPERTIES:
:ID:       e141b4bb-1ff2-42b0-9826-a58e02ccfb9c
:END:
...
(use-package! orderless
  :init
  (defhook! orderless:set-orderless-re-builder ()
    :hook ivy-mode-hook
...
(use-package! magit
  ...
  :setq
  (magit-completing-read-function . (cond ((bound-and-true-p ivy-mode) #'ivy-completing-read)
