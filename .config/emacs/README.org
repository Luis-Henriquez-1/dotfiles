...
(use-package! yasnippet-snippets
  :after yasnippet
  :init
  (awhen (-first (fn (s-contains-p "yasnippet-snippets" <>)) load-path)
...
(defun pass:email-account-plist (email)
  ...
  (shut-up!
    (alet (concat "email/" email)
      (-mapcat (fn (list (intern <>) (password-store-get-field it <>)))
