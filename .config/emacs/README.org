...
The name =leaf= is not very indicative of what the leaf macro does.
...
(defun leaf:make-defer (keyword)
  "Add KEYWORDS to `leaf-defer-keywords'."
...
(defun leaf:set-alias (alias name)
  "Add KEYNAMES to `leaf-alias-keywords'."
...
******* default normalizer                                            :disabled:
:PROPERTIES:
:ID:       9d60dd5b-9e3e-4536-9571-501d3e5735d1
:END:

#+begin_src emacs-lisp
(defvar leaf-default-normalizer
  `((or (eq leaf--key ,name)
...
(leaf:define-keyword! void-straight (before :straight)
  (progn (message "Calling straight...")
...
#+begin_src emacs-lisp
(leaf:define-keyword! alias (after :init)
  (-let [(alias . definition) leaf--value]
...
**** pop!
:PROPERTIES:
:ID:       108456c5-ed0b-4679-84d7-f766adc79b2b
:END:

#+begin_src emacs-lisp
(defmacro pop! (place &optional n)
  "Same as `pop' but pops N."
  (setq n (or n 1))
  `(--unfold (when (> it 0)
               (cons (pop ,place) (- it 1)))
             ,n))
